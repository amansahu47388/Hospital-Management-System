...
class IpdPatient(models.Model):
    ...
    total_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    paid_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    payment_mode = models.CharField(max_length=50, default="cash", blank=True)
    old_patient = models.BooleanField(default=False, null=True, blank=True)
    casualty = models.BooleanField(default=False, null=True, blank=True)
    allergies = models.TextField(blank=True, null=True)
    credit_limit = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    is_discharged = models.BooleanField(default=False, null=True, blank=True) 
