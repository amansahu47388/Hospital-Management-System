    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('old_patient', models.BooleanField(blank=True, default=False, null=True)),
                ('casualty', models.BooleanField(blank=True, default=False, null=True)),
                ('allergies', models.TextField(blank=True, null=True)),
                ('credit_limit', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('is_discharged', models.BooleanField(blank=True, default=False, null=True)),
                ('discharge_date', models.DateTimeField(blank=True, null=True)),
