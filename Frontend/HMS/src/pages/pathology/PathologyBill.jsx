...
export default memo(function PathologyBill() {
        ...
        <div className="bg-gray-50 rounded-lg shadow border border-gray-200 p-4 md:p-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
            <input
              ...
              className="border border-gray-300 px-3 py-2 rounded focus:ring-1  focus:ring-[#6046B5] focus:outline-none w-full lg:w-64"
            />
                ...
                <tbody className="bg-white">
                  {filteredBills.slice(0, limit).map((bill) => (
                    <tr key={bill.id} className="border border-gray-200 hover:bg-gray-50">
                      ...
                      <td
                        className={`p-2 text-center ${Number(bill?.balance || 0) > 0
                          ? "text-red-600"
                          : "text-green-600"
                          }`}
                      >
