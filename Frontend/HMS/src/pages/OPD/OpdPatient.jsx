            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
              ...
              <div className="flex flex-wrap gap-3 items-center justify-between lg:justify-end">
                <select
                  ...
                  className="border border-gray-200 px-2 py-2 rounded text-sm focus:outline-none focus:border-[#6046B5] focus:ring-1 focus:ring-[#6046B5]/30"
                >
              ...
              <table className="min-w-full text-sm ">
                <thead className="bg-gray-200">
                  {activeTab === "patient" ? (
                    ...
                    <tr>
                      <th className="px-2 py-2 text-left">Patient ID</th>
                      ...
                      <th className="px-2 py-2 text-left">Blood Group</th>
                      <th className="px-2 py-2 text-left">Action</th>
                    </tr>
                  ) : (
                    /* ================= OPD TABLE HEADER ================= */
                    <tr>
                      <th className="px-2 py-2 text-left">OPD No</th>
                      <th className="px-2 py-2 text-left">Patient Name</th>
                      <th className="px-2 py-2 text-left">Case ID</th>
                      <th className="px-2 py-2 text-left">Appointment Date</th>
                      <th className="px-2 py-2 text-left">Generated By</th>
                      <th className="px-2 py-2 text-left">Doctor</th>
                      <th className="px-2 py-2 text-left">Reference</th>
                      <th className="px-2 py-2 text-left">Symptoms</th>
                      <th className="px-2 py-2 text-left">Old Patient</th>
                      <th className="px-2 py-2 text-left">Previous Medical Issue</th>
                      <th className="px-2 py-2 text-left">Action</th>
                    </tr>
                  )}
                </thead>
