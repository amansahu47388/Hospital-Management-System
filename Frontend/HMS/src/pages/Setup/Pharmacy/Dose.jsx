        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white w-full max-w-lg rounded-md overflow-hidden shadow-xl">
            ...
            <div className="p-4 space-y-4">
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1">Dose Interval *</label>
                <input
              ...
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1">Dose Duration *</label>
                <input
