...
export default function OpdBillHeaderFooter() {
  const [headerImage, setHeaderImage] = useState("/uploads/printing/2.jpg");
      ...
      <div className="min-h-screen p-1 ">
        ...
        <div className="bg-white rounded-md p-4">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            {/* LEFT SIDEBAR (EXISTING COMPONENT) */}
            ...
            <div className="flex-1 space-y-6">
              ...
              {/* HEADER IMAGE SECTION (SAME AS OPD PRESCRIPTION) */}
              <div className="border rounded-md">
                ...
                <div className="p-4 space-y-3">
                  ...
                  <p className="text-xs text-blue-600">
                    uploads/printing/2.jpg
                  </p>

                </div>
              </div>

              {/* FOOTER CONTENT EDITOR (EXISTING COMPONENT) */}
              <div>
