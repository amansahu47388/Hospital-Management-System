...
import GenerateRadiologyBill from "../../components/Radiology/GenerateRadiologyBill"; 
import { getRadiologyBills, getRadiologyBillDetail, deleteRadiologyBill } from "../../api/radiologyApi";
import UpdateRadiologyBill from "../../components/Radiology/UpdateRadiologyBill";
import { useNotify } from "../../context/NotificationContext";
import RadiologyBillDetails from "../../components/Radiology/RadiologyBillDetails";


export default memo(function RadiologyBill() {
...
const handleDelete = async (billId) => {
  ...
  try {
    await deleteRadiologyBill(billId);
      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-6">
          <div className="bg-gray-50 rounded-lg shadow border border-gray-200 p-4 md:p-6">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
              <h2 className="text-lg font-semibold">Radiology Bills</h2>
              ...
              <div className="flex gap-2 flex-col sm:flex-row">
                ...
                <button   
                  onClick={() => navigate("/admin/radiology-tests")}
                  className="bg-gradient-to-b from-[#6046B5] to-[#8A63D2]
                             text-white px-4 py-2 rounded flex items-center gap-2 justify-center"
                >
                  Radiology Test
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
              <input
                ...
                className="border border-gray-300 px-3 py-2 rounded w-full lg:w-64 focus:border-[#6046B5] focus:ring-[#6046B5] outline-none"
              />
              ...
              {loading ? (
                ...
                <table className="min-w-full text-sm ">
                  <thead className="bg-gray-200 ">
                    <tr>
                      <th className="px-2 py-3 text-center">Bill No</th>
                      <th className="px-2 py-3 text-center">Case ID</th>
                      <th className="px-2 py-3 text-center">Doctor</th>
                      <th className="px-2 py-3 text-center">Patient Name</th>
                      <th className="px-2 py-3 text-center">Bill Date</th>
                      <th className="px-2 py-3 text-center">Generated By</th>
                      ...
                      <th className="px-2 py-3 text-center">Net Amount ($)</th>
                      <th className="px-2 py-3 text-center">Paid ($)</th>
