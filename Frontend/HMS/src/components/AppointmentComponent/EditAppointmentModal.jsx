...
import { updateAppointment, getDoctors, getShifts, getPriorities } from "../../api/appointmentApi";
import { getPatientList } from "../../api/patientApi";
import { getHospitalCharges } from "../../api/setupApi";
import { useNotify } from "../../context/NotificationContext";

export default function EditAppointmentModal({ open, onClose, data, onSuccess }) {
    ...
    const populateForm = () => {
        ...
        // Find charge category from charge ID
        const selectedCharge = charges.find(c => c.id === data.charge);
        ...
        setFormData({
            ...
            chargeCategory: selectedCharge?.charge_category || '',
            charge: data.charge || '',
            fees: data.fees || 0,
        });
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('Updating appointment data:', submitData);
            await updateAppointment(data.id, submitData);
        ...
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
            <div className="bg-white w-[98%] md:w-[90%] lg:w-[70%] rounded-lg shadow-lg max-h-[90vh] overflow-y-auto mx-auto">
                <form onSubmit={handleSubmit}>
                    {/* HEADER */}
                    <div className="flex justify-between sticky top-0 z-10 items-center px-6 py-4 bg-gradient-to-r from-[#6046B5] to-[#8A63D2] text-white rounded-t-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <select
                                    ...
                                    className=" form-field w-full border border-gray-300 px-3 py-2 rounded focus:ring-1 focus:ring-[#6046B5] outline-none"
                                    required
                                >
