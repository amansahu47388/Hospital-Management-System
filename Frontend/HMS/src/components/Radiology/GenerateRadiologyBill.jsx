...
import { createRadiologyBill, getRadiologyTests, searchPrescription } from "../../api/radiologyApi";
...
export default function GenerateRadiologyBill({ open, onClose }) {
  if (!open) return null;
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3 px-3 py-2 bg-gradient-to-b from-[#6046B5] to-[#8A63D2] text-white">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full lg:w-auto">
          ...
          <div className="flex items-center w-full sm:w-72">
            <div className="flex items-center bg-white rounded px-3 py-1 text-black w-full text-sm">
              <input
                className="w-full text-sm sm:text-base outline-none"
          ...
          <div className="grid md:grid-cols-2 gap-6 border-t border-gray-300 p-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                ...
                <div>
                  <label className="font-semibold">Paid Amount <span className="text-red-500">*</span></label>
                  <input
                    type="number"
                    className="border border-gray-300 px-3 py-2 rounded focus:ring-1  focus:ring-[#6046B5] focus:outline-none w-full"
                    value={paidAmount}
