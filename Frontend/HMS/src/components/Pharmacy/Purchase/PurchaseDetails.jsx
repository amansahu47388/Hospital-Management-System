  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 flex">
      <div className="bg-white w-full h-full flex flex-col">
        ...
        {/* INFO BAR */}
        <div className="border-b border-gray-300 px-4 py-2 text-xs flex flex-col md:flex-row md:justify-between gap-2">
          <div>
        ...
        {/* SUPPLIER INFO */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-2 gap-x-4 text-sm px-4 py-3 border-b border-gray-300">
        ...
        {/* TOTALS */}
        <div className="border-t border-gray-300 px-4 py-3 flex flex-col md:flex-row md:justify-between gap-4 text-sm">
          <div>
        ...
        {/* FOOTER */}
        <div className="border-t border-gray-300 p-3 flex justify-center md:justify-end">
